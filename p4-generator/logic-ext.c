...
#define HISTORY_SIZE {history_size}
#define DISJ_TABLE_SIZE {disj_table_size}
#define DISJ_TABLE_ROWCOUNT {disj_table_rowcount}
#define CONJ_TABLE_SIZE {conj_table_size}
