...
const bit<32> DISJ_TABLE_SIZE = 8;
		...
		if (hdr.sensor.isValid()) {
			...
			@atomic {
				...
				if (config == 0) {
					...
					disj_table_id.write(20, 1);
					disj_table_op.write(20, 4);
					disj_table_val.write(20, 2500);
					disj_table_id.write(21, 1);
					disj_table_op.write(21, 4);
					disj_table_val.write(21, 2500);
					disj_table_id.write(22, 1);
					disj_table_op.write(22, 4);
					disj_table_val.write(22, 2500);
					disj_table_id.write(23, 1);
					disj_table_op.write(23, 4);
					disj_table_val.write(23, 2500);
					disj_table_id.write(24, 1);
					disj_table_op.write(24, 4);
					disj_table_val.write(24, 2500);
					disj_table_id.write(25, 1);
					disj_table_op.write(25, 4);
					disj_table_val.write(25, 2500);
					disj_table_id.write(26, 1);
					disj_table_op.write(26, 4);
					disj_table_val.write(26, 2500);
					disj_table_id.write(27, 1);
					disj_table_op.write(27, 4);
					disj_table_val.write(27, 2500);
					disj_table_id.write(28, 1);
					disj_table_op.write(28, 4);
					disj_table_val.write(28, 2500);
					disj_table_id.write(29, 1);
					disj_table_op.write(29, 4);
					disj_table_val.write(29, 2500);
					disj_table_id.write(30, 1);
					disj_table_op.write(30, 4);
					disj_table_val.write(30, 2500);
					disj_table_id.write(31, 1);
					disj_table_op.write(31, 4);
					disj_table_val.write(31, 2500);
					disj_table_id.write(32, 1);
					disj_table_op.write(32, 4);
					disj_table_val.write(32, 2500);
					disj_table_id.write(33, 1);
					disj_table_op.write(33, 4);
					disj_table_val.write(33, 2500);
					disj_table_id.write(34, 1);
					disj_table_op.write(34, 4);
					disj_table_val.write(34, 2500);
					disj_table_id.write(35, 1);
					disj_table_op.write(35, 4);
					disj_table_val.write(35, 2500);
					disj_table_id.write(36, 1);
					disj_table_op.write(36, 4);
					disj_table_val.write(36, 2500);
					disj_table_id.write(37, 1);
					disj_table_op.write(37, 4);
					disj_table_val.write(37, 2500);
					disj_table_id.write(38, 1);
					disj_table_op.write(38, 4);
					disj_table_val.write(38, 2500);
					disj_table_id.write(39, 1);
					disj_table_op.write(39, 4);
					disj_table_val.write(39, 2500);
			...
			conj_table.read(conj_entry_0, hdr.sensor.sensorId * CONJ_TABLE_SIZE + 0);
				if (conj_entry_0 != 0) {
					...
					disj_table_op.read(opcode, conj_entry_0 * DISJ_TABLE_SIZE+4);
					disj_table_val.read(value, conj_entry_0 * DISJ_TABLE_SIZE+4);
					disj_table_id.read(sensor_id, conj_entry_0 * DISJ_TABLE_SIZE+4);
					sensor_index.read(index, sensor_id);
					sensor_history.read(sensor_value, sensor_id * HISTORY_SIZE + index);
					if (opcode == 1 && sensor_value == value) disj = true;
					if (opcode == 2 && sensor_value > value) disj = true;
					...
					disj_table_op.read(opcode, conj_entry_0 * DISJ_TABLE_SIZE+5);
					disj_table_val.read(value, conj_entry_0 * DISJ_TABLE_SIZE+5);
					disj_table_id.read(sensor_id, conj_entry_0 * DISJ_TABLE_SIZE+5);
					sensor_index.read(index, sensor_id);
					sensor_history.read(sensor_value, sensor_id * HISTORY_SIZE + index);
					if (opcode == 1 && sensor_value == value) disj = true;
					if (opcode == 2 && sensor_value > value) disj = true;
					...
					disj_table_op.read(opcode, conj_entry_0 * DISJ_TABLE_SIZE+6);
					disj_table_val.read(value, conj_entry_0 * DISJ_TABLE_SIZE+6);
					disj_table_id.read(sensor_id, conj_entry_0 * DISJ_TABLE_SIZE+6);
					sensor_index.read(index, sensor_id);
					sensor_history.read(sensor_value, sensor_id * HISTORY_SIZE + index);
					if (opcode == 1 && sensor_value == value) disj = true;
					if (opcode == 2 && sensor_value > value) disj = true;
					...
					disj_table_op.read(opcode, conj_entry_0 * DISJ_TABLE_SIZE+7);
					disj_table_val.read(value, conj_entry_0 * DISJ_TABLE_SIZE+7);
					disj_table_id.read(sensor_id, conj_entry_0 * DISJ_TABLE_SIZE+7);
					sensor_index.read(index, sensor_id);
					sensor_history.read(sensor_value, sensor_id * HISTORY_SIZE + index);
					if (opcode == 1 && sensor_value == value) disj = true;
					if (opcode == 2 && sensor_value > value) disj = true;
